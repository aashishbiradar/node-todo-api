...
describe('GET /todos/:id',()=>{
    ...
    it('should get todo from other user',(done)=>{
        var testId2 = todos[1]._id.toHexString();
        request(app)
        .get(`/todos/${testId2}`)
        .set('x-auth',users[0].tokens[0].token)
        .expect(404)
...
describe('POST /users/login', () => {
    ...
    it('should reject invalid login request', (done) => {
        request(app)
        .post('/users/login')
